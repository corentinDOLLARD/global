        ...
        <div className="max-w-3xl">
          ...
          >
            <span className="inline-flex items-center gap-2.5 liquid-glass-dark text-white/70 text-sm font-medium px-5 py-2.5 rounded-full">
              ...
              Collection Printemps-&Eacute;t&eacute; 2026
            </span>
          </motion.div>
          ...
          >
            D&eacute;couvrez une s&eacute;lection de pi&egrave;ces d&apos;exception,
            fa&ccedil;onn&eacute;es par les plus grands artisans. Chaque cr&eacute;ation
            raconte une histoire d&apos;excellence.
          </motion.p>
          ...
          >
            {[
              { value: "150+", label: "Artisans d'exception" },
              { value: "40+", label: "Maisons partenaires" },
              { value: "100%", label: "Pi&egrave;ces certifi&eacute;es" },
            ].map((stat) => (
              <div key={stat.label}>
