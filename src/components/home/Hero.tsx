        ...
        <div className="max-w-3xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <span className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm text-white/80 text-sm font-medium px-4 py-2 rounded-full border border-white/10">
              ...
              PrenyPreny v2.0 — Nouvelle expérience
            </span>
          </motion.div>
          ...
          <motion.h1
            ...
            className="mt-8 text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-bold text-white leading-[0.9] tracking-tight font-display"
          >
            L&apos;art du
            <br />
          ...
          >
            Découvrez une sélection premium de produits soigneusement choisis.
            Design exceptionnel, qualité sans compromis.
          </motion.p>
