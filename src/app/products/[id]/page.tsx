          ...
          >
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        selectedSize === size
                          ...
                          : "bg-surface-dark hover:bg-gray-200"
                      )}
                    >
                      {size}
                    </button>
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
              ...
              <motion.button
                ...
                className={cn(
                  "flex-1 flex items-center justify-center gap-3 py-4 rounded-2xl font-semibold text-white transition-all duration-300",
                  addedToCart
                    ? "bg-success"
              ...
              <motion.button
                whileTap={{ scale: 0.9 }}
                className="p-4 rounded-2xl border-2 border-gray-200 hover:border-accent hover:text-accent transition-colors"
              >
            ...
            <div className="mt-10 grid grid-cols-3 gap-4">
              {[
                ...
                <div
                  key={label}
                  className="flex flex-col items-center text-center gap-2 p-3 rounded-2xl bg-surface"
                >
